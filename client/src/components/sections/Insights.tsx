    ...
    <section id="insights" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-3xl md:text-4xl font-serif font-bold text-primary mb-6">Expert Perspectives</h3>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            ...
            >
              <Card className="h-full border-none shadow-sm hover:shadow-md transition-all duration-300 rounded-sm bg-white overflow-hidden group cursor-pointer">
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-xl font-serif text-primary group-hover:text-accent transition-colors flex items-start justify-between gap-2">
                    {insight.title}
